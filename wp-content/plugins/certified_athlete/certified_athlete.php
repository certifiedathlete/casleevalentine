 ...
 * Plugin URI: http://certifiedathlete.com
 * Description: This plugin creates the certified athlete functionality
 * Version: 0.1
 * Author: Caslee Valentine
 * Author URI: http://certifiedathlete.com
 * License: GPL2
 */
?>
<?php
...
add_action('admin_menu', 'certified_athlete_menu');

/** Step 1. */
function certified_athlete_menu() {
    add_options_page('Certified Athlete Options', 'Certified Athlete', 'manage_options', __FILE__, 'certified_athlete_options');
    add_dashboard_page('Certified Athlete Dashboard', 'Certified Athlete', 'read', __FILE__, 'certified_athlete_dashboard');
    add_menu_page( 'Certified Athlete Menu', 'Certified Athlete', 'manage_options', 'custompage', 'certified_athlete_menu', plugins_url( 'myplugin/images/icon.png' ), 26 );
}

/** Step 3. */
function certified_athlete_dashboard() {
...
function certified_athlete_options() {
//    if (!current_user_can('manage_options')) {
//        wp_die(__('You do not have sufficient permissions to access this page.'));
        ?>
        <div class="wrap">
