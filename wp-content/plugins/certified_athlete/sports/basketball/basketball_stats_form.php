    ...
    $content_slider_stats.="	
						  ...
						  <tr>
							...
							<td width=\"56\" valign=\"top\"><input class=\"btnUpdate\" name=\"btnUpdate\" type=\"submit\" id=\"btnUpdate\" value=\"Update\" />
							  ...
							  <input name=\"player_stats_id\" type=\"hidden\" value=\"" . $player_stats_id . "\" />
							  <input name=\"player_id\" type=\"hidden\" value=\"" . $player_id . "\" />
							  <input name=\"sports_table\" type=\"hidden\" value=\"" . $sports_table . "\" />
                                                          <input name=\"edit_function\" type=\"hidden\" value=\"sports_stats\" />
                                                          <input name=\"action\" type=\"hidden\" value=\"edit_sports_stats\" />
...
/*
  ...
  <!-- Begin Edit Box -->
  <div class="boxHeader">
  <a href="#" onclick="return false" onmousedown="javascript:toggleSlideBox('<?php echo $sports_table; ?>_edit_tab_content<?php echo $stats_i; ?>');">
  <img src="images/toggleBtn1.png" alt="Toggle" width="22" height="30" border="0" style="position:relative; top:6px;" />
  <h2><?php echo $stat_array[$stats_i]['team_name']; ?> vs <?php echo $stat_array[$stats_i]['opponent']; ?></h2>
  </a>
  </div>
  ...
  <div class="editBox" id="<?php echo $sports_table; ?>_edit_tab_content<?php echo $stats_i; ?>" style="display:none;">

  <?php echo $stat_array[$stats_i]['team_name']; ?> vs <?php echo $stat_array[$stats_i]['opponent']; ?>
