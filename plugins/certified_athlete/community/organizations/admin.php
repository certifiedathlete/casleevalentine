<?php
ob_start();
include_once($_SERVER['DOCUMENT_ROOT']."/wp-load.php");//include in all view files
print_r($ca_organization);

//echo CA_PLUGIN_URL;
?>
<div class="wrap">
    <h2>Organizations <a href="http://casleevalentine.com/wp-admin/post-new.php" class="add-new-h2">Add New</a></h2>
    <ul class="subsubsub">
