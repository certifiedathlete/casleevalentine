...
<div class="content_box" >
    <?php
    echo "<br />";
    CA_UI::render_rank_box('dark_blue', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box       
    CA_UI::render_rank_box('gold', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box 
    CA_UI::render_rank_box('dark_green', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box

    CA_UI::render_rank_box('dark_purple', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box
    CA_UI::render_rank_box('orange', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box 
    CA_UI::render_rank_box('red', 'left', $ca_user, $ca_sports_rank); // renders a profile rank box 
    ?>
