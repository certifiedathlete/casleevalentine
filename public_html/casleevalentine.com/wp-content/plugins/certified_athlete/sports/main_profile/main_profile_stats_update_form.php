...
$sports_table = CA_Security::clean_text($wpdb->escape($_REQUEST['sports_table']));
$stats_i = CA_Security::clean_text_number_only($wpdb->escape($_REQUEST['stats_i'])); //pass in the value of the div id
$player_id = CA_Security::clean_text_number_only($wpdb->escape($_REQUEST['player_id']));
$player_stats_id = CA_Security::clean_text_number_only($wpdb->escape($_REQUEST['player_stats_id']));
...
//'avg_punt_distance' 			    => 		CA_Security::clean_text($wpdb->escape($_REQUEST['avg_punt_distance']),
...
//'text' 	                        => 		CA_Security::clean_text($wpdb->escape($_REQUEST['text']),
